...
const HowItWorks = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between w-full lg:w-[81.25rem] mt-[5.125rem] px-4 lg:px-0">
      <p className="text-[1.5rem] font-medium pt-8">How it Works</p>

      <div className="w-full lg:w-[56.4375rem] flex flex-col border-b border-[#E6E6E6] gap-[3rem]">
        {howItWorksData.map((item, index) => (
          <div
            key={index}
            className={`flex flex-col lg:flex-row justify-between pt-8 ${
            ...
            <div className="flex flex-col lg:flex-row items-start w-full">
              ...
              <div className="flex flex-col lg:flex-row items-center w-full gap-[2rem]">
                <div className="flex flex-col w-full">
                  ...
                  <p className="mt-[1rem] w-full text-[1rem] text-[#6A6161]">
                    {item.description}
                  </p>
                </div>
              </div>
